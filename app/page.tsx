...
export default function Home() {
  return (
    <main className="grid min-h-screen place-items-center p-4 md:p-24">
      {/* Título e texto */}
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-4">Simplificamos a análise de ações</h1>
      ...
      <div>
        ...
        <div className="ml-4 mb-4">
          <h2 className="text-xl mb-4">QUAIS SÃO AS VANTAGENS??</h2>
        </div>
